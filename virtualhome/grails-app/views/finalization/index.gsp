    ...
    <div class="row">
      ...
      <g:form controller="finalization" action="complete" class="form-horizontal finalize" name="accountform">
          ...
          <div class="controls">
            ...
            <div class="span4">
              <div class="help-block">
                ...
                <p>International numbers are supported. If you're located outside Hong Kong please be sure to add your <a href="http://en.wikipedia.org/wiki/List_of_mobile_phone_number_series_by_country" target="_blank">international prefix</a> to the start of your number.
                ...
                <p>If you elect not to supply your mobile number and forget your password you'll need to contact administrators directly which may take some time to complete preventing your access to HKAF connected services in the interim.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="form-actions">
          <p class="text-muted"><i class="icon-info-sign"></i> <strong>Intensive cryptography coming up!! Your browser will take a few seconds to talk with the HKAF Virtual Home after you click, there is no need to refresh.</strong></p>
