...
<html>
  ...
  <body>
    <div class="hero-unit">
      ...
      <p>To login to services simply select <strong>VHAF Virtual Home</strong> from the list of available organisations when asked to nominate your organisation.</p>
