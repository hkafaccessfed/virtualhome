      ...
      <div class="span12">
        <div class="well well-small">
          <g:form action="twosteplogin" id="${managedSubjectInstance.id}" method="post" class="form form-login form-validating">
            ...
            <p>Please enter the two-step token value for your account which is available from your smart phone app.</p>

            <fieldset>
              <div class="control-group">
                <label class="control-label" for="totp"><g:message code="label.totp"/></label>
                <div class="controls">
