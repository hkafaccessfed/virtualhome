...
<div class="alert alert-info">
  ...
  <p>If you're unable to contact an account administator as shown above (or if there are no administrators shown) please get in touch with <a href="mailto:support@hkaf.edu.hk">HKAF support at support@hkaf.edu.hk</a>. Please provide your username and details of who you've attempted to contact above as part of the email so we can assist you further.</p>
</div>
