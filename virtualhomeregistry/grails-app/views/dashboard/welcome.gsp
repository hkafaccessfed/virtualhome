...
<html>
  ...
  <body>
    ...
    <div class="hero-unit">
      <h2>Welcome to the AAF Virtual Home Registry</h2>
      ...
      <div class="row">
        <div class="span5">
          ...
          <div class="descriptive-text">
            <p>I have a VHR account that lets me access services connected to the AAF.</p>
        ...
        <div class="span5">
          ...
          <div class="descriptive-text">
            <p>I'm an administrator of VHR Organisations or Groups.</p>
            <p>I'd like to create new accounts or manage existing accounts.</p>
          </div>
          <p>
            <center><g:link controller="dashboard" action="dashboard" class="btn btn-large btn-info"><i class="icon icon-white icon-wrench"></i> Login to VHR dashboard</g:link><br>
