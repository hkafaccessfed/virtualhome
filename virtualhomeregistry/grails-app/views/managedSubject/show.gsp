...
<html>
  ...
  <body>
    ...
    <ul class="nav nav-tabs">
      ...
      <li><a href="#tab-eventlog" data-toggle="tab"><g:message code="label.eventlog" /></a></li>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <g:else>
                      <span aria-labelledby="accountexpiry-label"><g:message code="label.doesnotexpire"/></span></td>
                    </g:else>
                  </td>
                </tr>
