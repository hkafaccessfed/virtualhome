<html>
  ...
  <body>
    ...
    <ul class="breadcrumb">
      ...
      <li class="active"><g:message code="branding.nav.breadcrumb.managedsubject.createcsv"/></li>
    </ul>
    ...
    <g:if test="${errors && !status}">
      <h3 class="muted"><g:message code="views.aaf.vhr.managedsubject.createcsv.errors.csv.heading"/></h3>
      <p><g:message code="views.aaf.vhr.managedsubject.createcsv.errors.csv.detail"/></p>
    ...
    <g:if test="${managedSubjectInstances && !status}">
      <h3 class="muted"><g:message code="views.aaf.vhr.managedsubject.createcsv.errors.account.heading"/></h3>
      <p><g:message code="views.aaf.vhr.managedsubject.createcsv.errors.account.detail"/></p>
      <p><g:message code="views.aaf.vhr.managedsubject.createcsv.errors.account.nocreation"/></p>
    ...
    <p>
      <strong><g:message code="views.aaf.vhr.managedsubject.createcsv.format"/></strong>
    </p>
    <ul>
      <li>[cn] - <g:message code="views.aaf.vhr.managedsubject.createcsv.format.cn"/></li>
      <li>[email] - <g:message code="views.aaf.vhr.managedsubject.createcsv.format.email"/></li>
      <li>[eduPersonAffiliation] - <g:message code="views.aaf.vhr.managedsubject.createcsv.format.aff"/></li>
      <li>[expiry-in-months] - <g:message code="views.aaf.vhr.managedsubject.createcsv.format.expiry"/></li>
    </ul>
    ...
    <g:uploadForm action="savecsv" class="form form-horizontal">
      <fieldset>
        ...
        <div class="control-group">
          <label class="control-label" for="csvdata"><g:message code="label.file"/></label>
          <div class="controls">
