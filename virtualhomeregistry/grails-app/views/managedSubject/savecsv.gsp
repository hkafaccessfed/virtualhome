<html>
  ...
  <body>
    ...
    <ul class="breadcrumb">
      ...
      <li class="active"><g:message code="branding.nav.breadcrumb.managedsubject.savecsv"/></li>
    </ul>

    <h2><g:message code="views.aaf.vhr.managedsubject.savecsv.heading"/></h2>
    
    <p>
      <g:message code="views.aaf.vhr.managedsubject.savecsv.details" args="${[linecount, groupInstance.name]}"/>
    </p>

    <h4><g:message code="label.accounts"/></h4>
    <table class="table table-borderless">
      <thead>
        <tr>
          <th><g:message code="label.cn"/></th>
          <th><g:message code="label.email"/></th>
          <th><g:message code="label.view"/></th>
        </tr>
      </thead>
      <tbody>
        <g:each in="${managedSubjectInstances}" var="managedSubjectInstance">
          <tr>
            ...
            <td><g:link controller="managedSubject" action="show" id="${managedSubjectInstance.id}" class="btn btn-small"><g:message code="label.view"/></g:link></td>
          </tr>
        </g:each>
      </tbody>
    </table>
